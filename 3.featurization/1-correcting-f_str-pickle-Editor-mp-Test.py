...
def main(fstrPickleDir, logPath, outPath):
    if not os.path.isdir(logPath):
        if not os.path.isdir("../../data/testDataset/Logs/"):
            os.mkdir("../../data/testDataset/Logs/")
        os.mkdir(logPath)
...
if __name__=="__main__":
    fstrPickleDir = "../../data/testDataset/f_str-Pickles_Pre/"

    outPath = "../../data/testDataset/f_str-Pickles/"
    logPath = "../../data/testDataset/Logs/f_str-Pickles/"
