...
def mapFIFtoFeatures(args):
    ...
    try:
        alreadyDones = pickle.load(open(direc + "topNfeats/" + family + "-" + str(len(doneCount)) + '-consideredFeaturesIndices.pickle', 'rb'))
    except:
...
def main(N):
    ...
    # print(fIF)
    dones = {'mirai': 4509, 'xorddos': 7002, 'local': 3007, 'tsunami': 1000, 'generica': 500, "dofloo": 9502, "elknot": 9502, "gafgyt": 9502, "ganiw": 9503, "setag": 9500}
